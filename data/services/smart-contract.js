    ...
    SmartContractsForBusinesses: [
        {
            ...
            title: '房地产',
            description: '智能合约可简化房地产行业中交易领域（例如租赁，购买和销售）的管理操作。该技术减轻了文字工作的负担和财务成本',
            ...
            title: '汽车',
            description: '在汽车工业中，智能合约用于保险程序。合约是定制的，包括真实的车辆性能信息。也可以自动执行保险金的收取和保险索赔后的赔付。',
            ...
            title: '金融',
            description: '金融机构一般使用以太坊的智能合约，利用区块链技术来改善数据质量，加强对投资者权益的保护并增强金融市场的功能。',
            imgSrc: '/images/Services/SmartContracts/SC6.png',
            imgSrcSet: '/images/Services/SmartContracts/SC6@2x.png',
            moreLink: '#'
        },
    ]
}